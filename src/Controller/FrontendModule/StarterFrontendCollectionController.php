...
namespace Steffenu\StarterBundle\Controller\FrontendModule;
...
/**
 * Class StarterFrontendCollectionController
 *
 * @FrontendModule(StarterFrontendCollectionController::TYPE, category="starter_frontend_modules", template="mod_starter_frontend_collection")
 */
class StarterFrontendCollectionController extends AbstractFrontendModuleController
{
    public const TYPE = 'starter_frontend_collection';
